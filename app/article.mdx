...
import Toggolable from './utils/Toggolable.tsx'
...
<Toggolable title="Introduction" maxHeight={2500} opened={true}>
<Prose>
...
<Toggolable title="Time to Abstract" maxHeight={3000}>
<Prose>
...
<Toggolable title="A closer look" maxHeight={6000}>
...
<Gif
  url="https://giphy.com/embed/5SxgjvUrLwdsxYrkB3"
  width="480"
  height="480"
/>
...
<Toggolable title="In a perfect world">
...
<TurtleSketch withStack={false} defaultString="FF+F-F" />
...
<TurtleSketch withStack={true} defaultString="FF[+F][-F]" />
...
<Toggolable title="A binary comeback">
<Prose>
...
<TurtleSketch withStack={true} defaultString="F[+F[+F[+T][-T]][-F[+T][-T]]][-F[+F[+T][-T]][-F[+T][-T]]]" />
...
<Toggolable title="Beyond the example">
...
<Toggolable title="Computational gardening">
<Prose>
...
<Toggolable title="The Faraway Journey, Farewell Friends">
<Prose>
...
- **Paolo Ginefra**:<RoleList roles={['Applet Development', 'Font End', 'Project Management', 'Research', 'Writing']}/>
</Prose>
</Toggolable>
